...
<div class="d-flex justify-content-between mb-4 mt-5 m-5">
            <button type="button" class="btn" style="background-color: #267899; color: white;" data-bs-toggle="modal" data-bs-target="#criar" data-bs-whatever="@mdo"> + Novo Ambiente</button>
        </div>
...
<!-- modal  -->
  ...
  <div class="modal-dialog">
    ...
    <div class="container mt-3">
        <h2 class="mb-4"> <i class="bi bi-door-open-fill"></i> Todos os Ambientes</h2>
        <div class="container">
